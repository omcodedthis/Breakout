...
# top_border is deleted. This is to prevent a copy of them being drawn at their initial location, if run_game(canvas)
# is called again (provided that turns is not 0).
